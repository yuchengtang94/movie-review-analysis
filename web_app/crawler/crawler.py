...
def get_review_html(movie_name):
    try:
        search_url = "https://www.rottentomatoes.com/search/?search="+quote(movie_name)
        option = webdriver.ChromeOptions()
        option.add_argument('headless')
        driver = webdriver.Chrome(chrome_options=option)
        driver.get(search_url)
        driver.find_element_by_xpath("//section[@id='movieSection']//a[1]").click()
        driver.find_element_by_xpath("//section[@id='audience_reviews']//div[@class='view-all']/a").click()
